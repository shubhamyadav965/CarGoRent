    ...
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-gray-500">
      <div className="flex flex-wrap justify-between items-start gap-8 md:gap-6 pb-6 border-borderColor border-b">
        <div>
          ...
          <p className="mx-w-80 mt-3">
            Premium car rental service offering a wide range of vehicles for all
            your travel needs. Experience luxury and comfort on the road with
            us.
          </p>
